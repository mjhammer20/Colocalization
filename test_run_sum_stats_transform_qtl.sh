...
SUM_STATS_FILE="/mnt/working/locus_reports/qtl/eqtl/amp_ad/CER_Mayo_cis_eQTL_release.csv"
...
python3 -u src/sum_stats_transform.py \
    ...
    2>&1 | tee /mnt/output/output/coloc/logs/test_run_sum_stats_transform_qtl.log